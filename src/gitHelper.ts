 ...
 * 2. user repo 用户写代码用的 repo, 提交完的代码会被用户推送到 bare repo 中，并且会触发 git hook: `post-receive`
 ...
 * 3. 触发 pipeline
 */
export async function triggerPull(repoPath: string, commitId: string) {
  console.log("Project locate at", repoPath);
